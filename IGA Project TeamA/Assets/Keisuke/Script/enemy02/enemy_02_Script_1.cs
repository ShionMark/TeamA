...
public class enemy_02_Script_1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (enemy_02_weakness_01_1.e2_Weak01HP <= 0)
        {
        ...
        if (enemy_02_weakness_02_1.e2_Weak02HP <= 0)
        {
        ...
        if (enemy_02_BodyScript_1.e2_HP <= 0)
        {
