...
public class enemy_boss_05_BodyScript : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            case ("AutoBullet"):
                eb_5_HP -= Shooting.Shooting_2.AUTO_BULLET[Shooting_2.iNowChar, Shooting_2.iNowBulletLevel];
                break;
            case ("Bullet"):
                eb_5_HP -= Shooting.Shooting_2.CHARGE_BULLET[Shooting_2.iNowChar, Shooting_2.iNowBulletLevel];
                break;
